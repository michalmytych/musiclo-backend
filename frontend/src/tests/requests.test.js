...
test('Create song request', () => {
    ...
    args.obj = {
        'name'              : "TESTsongTESTsongTESTsongTEST",
        'explicit'          : 0,
        'key'               : 1,
        'mode'              : 1,
        'danceability'      : 0.12,
        ...
        'spotify_link'      : "https://testtesttesttesttest",
        'album_id'          : "0ajAHhhFTLdF1bMLMDG8BX",
        'artists_ids'       : [
            "06xa1OLBsMQJFXcl2tQkH4", 
            "06yvjjrPokJGC66DzFfCkF"
        ]
    }

    return createItemRequest(args).then(
        status => {
...
test('Create album request', () => {
    let args = {}; args.category = "albums";
    args.obj = {
        'name'          : "TESTalbumTESTalbumTESTalbum", 
        'release_date'  : "2006-07-25",
        'spotify_link'  : "https://testtesttesttesttest",
        'artist_ids'    : ["070fV7yF5r09T89LHE7HKF", "070RPr7Euzwf3yboA9Xp2U"]
    }
...
test('Create artist request', () => {
    let args = {}; args.category = "artists";
    args.obj = {
        'name'              : "TESTartistTESTartistsTESTartistsTEST",
        'description'       : "lorem lorem lorem lorem lorem lorem lorem lorem",
        'spotify_link'      : "https://testtesttesttesttest",
        'albums_ids'        : ["0APePhDDGAvshjJ88zRdWc", "0APTTn4fjE7DgZ6vMWd8kL"],
        'country'           : "GB"
    }
